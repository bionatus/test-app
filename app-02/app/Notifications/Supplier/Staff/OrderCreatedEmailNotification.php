...
class OrderCreatedEmailNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return (new OrderCreationEmail($this->order))->to($notifiable->email, $notifiable->name)
