...
namespace App\Http\Resources\Api\V3\Account\Profile;
...
class BaseResource extends JsonResource implements HasJsonSchema
{
    ...
    public function toArray($request): array
    {
        ...
        $suppliersPath = URL::route(RouteNames::API_V3_ACCOUNT_SUPPLIER_INDEX);
        $suppliersPage = $user->visibleSuppliers()->scoped(new Preferred($user))->paginate()->withPath($suppliersPath);
        ...
        return [
            ...
            'suppliers'         => new SupplierCollection($suppliersPage),
        ];
    }
    ...
    public static function jsonSchema(): array
    {
        return [
            'properties'           => [
                ...
                'suppliers'         => SupplierCollection::jsonSchema(),
            ],
            'required'             => [
                'id',
                'photo',
