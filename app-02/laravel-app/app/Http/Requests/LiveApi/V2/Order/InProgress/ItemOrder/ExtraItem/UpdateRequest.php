...
namespace App\Http\Requests\LiveApi\V2\Order\InProgress\ItemOrder\ExtraItem;
...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [
            RequestKeys::ITEMS . '.*.uuid.exists' => 'Each item in item orders must exist. They must belong to an order and must not have been added in the initial request.',
        ];
    }
}
