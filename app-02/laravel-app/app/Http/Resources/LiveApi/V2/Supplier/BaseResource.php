...
class BaseResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        $bidNumberRequired = App::make(GetSupplierSetting::class,
            ['model' => $this->resource, 'slug' => Setting::SLUG_BID_NUMBER_REQUIRED])->execute();
        ...
        return [
            ...
            'bid_number_required'     => $bidNumberRequired,
        ];
    }
    ...
    public static function jsonSchema(): array
    {
        return [
            ...
            'properties'           => [
                ...
                'bid_number_required'     => ['type' => ['boolean']],
            ],
            'required'             => [
                'id',
                'name',
