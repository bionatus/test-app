...
class OrderCanceledByUserEmailNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return (new OrderCanceledEmail($this->order))->to($notifiable->email, $notifiable->name)
