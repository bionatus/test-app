...
class UpdateInboundCounter implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $key          = $databaseNode . $this->supplier->getRouteKey() . DIRECTORY_SEPARATOR . 'inbound';
        $value        = $this->supplier->orders()->scoped(new ByLastSubstatuses(Substatus::STATUSES_PENDING))->count();
