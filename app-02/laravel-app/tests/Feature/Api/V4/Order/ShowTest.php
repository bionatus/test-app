...
class ShowTest extends TestCase
{
    ...
    private string $routeName = RouteNames::API_V4_ORDER_SHOW;
    ...
    public function it_displays_an_order()
    {
        ...
        OrderSubstatus::factory()->usingOrder($order)->usingSubstatusId(Substatus::STATUS_PENDING_REQUESTED)->create();
        $orders = Order::factory()->usingSupplier($supplier)->count(3)->create();
    ...
    public function it_logs_the_view_if_requirements_are_met(
        ...
        Order::factory()->usingSupplier($supplier)->count(3)->pending()->create();
    ...
    {
        return [
            //substatusId, pendingApprovalViewExist, expected
