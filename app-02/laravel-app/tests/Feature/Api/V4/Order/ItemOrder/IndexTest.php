...
namespace Tests\Feature\Api\V4\Order\ItemOrder;
...
class IndexTest extends TestCase
{
    ...
    private string $routeName = RouteNames::API_V4_ORDER_ITEM_ORDER_INDEX;
    ...
    /** @test */
    public function it_returns_a_list_of_active_order_items()
    {
        ...
        $notAvailablePart = Part::factory()->create();
        AirFilter::factory()->usingPart($notAvailablePart)->create();
        ItemOrder::factory()
            ->usingOrder($order)
            ->usingItem($notAvailablePart->item)
