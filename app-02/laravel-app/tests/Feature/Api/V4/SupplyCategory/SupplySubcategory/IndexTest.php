...
namespace Tests\Feature\Api\V4\SupplyCategory\SupplySubcategory;
...
class IndexTest extends TestCase
{
    ...
    private string $routeName = RouteNames::API_V4_SUPPLY_CATEGORY_SUBCATEGORY_INDEX;
    ...
    public function it_searches_by_search_string_param()
    {
        ...
        $expectedCategories->add(SupplyCategory::factory()
            ->visible()
            ->usingParent($supplyCategory)
            ->create(['name' => 'inside search']));
        $expectedCategories->add(SupplyCategory::factory()
            ->visible()
            ->usingParent($supplyCategory)
            ->create(['name' => 'inside search 2']));
