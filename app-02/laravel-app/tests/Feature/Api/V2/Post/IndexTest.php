...
class IndexTest extends TestCase
{
    ...
    private string $routeName = RouteNames::API_V2_POST_INDEX;
    ...
    /** @test */
    public function it_display_a_list_of_posts_newest_first()
    {
    ...
    public function validated_parameters_are_present_in_pagination_links()
    {
        ...
        $parameters = [
            RequestKeys::SEARCH_STRING => 'any string',
            RequestKeys::TAGS          => [$tag],
            RequestKeys::TYPE          => 'other',
            'invalid'                  => 'invalid',
        ];
