...
namespace Tests\Feature\Api\V3\Supply\Search;

use App\Constants\RequestKeys;
use App\Constants\RouteNames;
use App\Http\Controllers\Api\V3\Supply\SearchController;
...
class InvokeTest extends TestCase
{
    ...
    private string $routeName = RouteNames::API_V3_SUPPLY_SEARCH_INDEX;
