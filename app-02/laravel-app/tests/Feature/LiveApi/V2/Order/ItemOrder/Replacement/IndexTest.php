...
namespace Tests\Feature\LiveApi\V2\Order\ItemOrder\Replacement;

use App\Constants\RouteNames\LiveApiV2;
use App\Constants\RouteParameters;
use App\Http\Controllers\LiveApi\V2\Order\ItemOrder\ReplacementController;
...
class IndexTest extends TestCase
{
    ...
    private string $routeName = LiveApiV2::LIVE_API_V2_ORDER_ITEM_ORDER_REPLACEMENT_INDEX;
    ...
    /** @test */
    public function it_displays_an_error_if_the_item_orders_belongs_to_another_order()
    {
        $staff = Staff::factory()->createQuietly();
        $order = Order::factory()->usingSupplier($staff->supplier)->create();
