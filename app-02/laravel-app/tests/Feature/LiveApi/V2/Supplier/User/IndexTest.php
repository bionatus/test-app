...
namespace Tests\Feature\LiveApi\V2\Supplier\User;

use App\Constants\RequestKeys;
use App\Constants\RouteNames\LiveApiV2;
use App\Http\Controllers\LiveApi\V2\Supplier\UserController;
...
class IndexTest extends TestCase
{
    ...
    private string $routeName = LiveApiV2::LIVE_API_V2_SUPPLIER_USER_INDEX;
