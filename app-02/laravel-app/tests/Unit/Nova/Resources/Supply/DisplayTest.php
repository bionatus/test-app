...
class DisplayTest extends ResourceTestCase
{
    ...
    public function dataProvider(): array
    {
        return [
            ...
            ['internal_name', true, true, true, true],
            ['visible_at', true, true, true, true],
            ['supplyCategory', true, true, true, true],
        ];
    }
     ...
     * @throws FieldNotFoundException
     */
    public function its_internal_name_field_is_sortable()
    {
     ...
     * @throws FieldNotFoundException
     */
    public function its_supplyCategory_field_is_sortable()
    {
