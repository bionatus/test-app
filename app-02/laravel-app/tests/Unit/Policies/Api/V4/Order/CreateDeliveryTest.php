...
class CreateDeliveryTest extends TestCase
{
    ...
    /** @test */
    public function it_disallows_another_user_to_create_order_delivery()
    {
        ...
        $this->assertFalse($policy->createDelivery($notOwner, $order));
    }
     ...
     */
    public function it_disallows_the_owner_to_create_delivery_of_a_non_pending_approval_fulfilled_order(
        $orderStatus,
        $expectedResult
    ) {
        ...
        $this->assertEquals($expectedResult, $policy->createDelivery($owner, $order));
    }
