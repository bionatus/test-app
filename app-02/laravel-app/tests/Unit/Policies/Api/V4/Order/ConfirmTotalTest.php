...
class ConfirmTotalTest extends TestCase
{
    use RefreshDatabase;

    /** @test */
    public function it_disallows_another_user_to_confirm_total_on_a_pickup_order()
    {
        ...
        $this->assertFalse($policy->confirmTotal($notOwner, $order));
    }

    /** @test */
    public function it_disallows_to_confirm_total_on_a_pickup_order_if_the_order_is_not_pickup()
    {
        ...
        $this->assertFalse($policy->confirmTotal($owner, $order));
    }
     ...
     */
    public function it_disallows_to_confirm_total_on_a_pickup_order_if_the_order_is_not_approved_ready_for_delivery(
        int $orderStatus,
        bool $expectedResult
    ) {
        $owner    = User::factory()->create();
        ...
        $this->assertEquals($expectedResult, $policy->confirmTotal($owner, $order));
    }
