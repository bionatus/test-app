...
use App\Notifications\Supplier\Staff\OrderApprovedEmailNotification;
...
class OrderApprovedEmailNotificationTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $reflection = new ReflectionClass(OrderApprovedEmailNotification::class);
    ...
    public function it_uses_database_connection()
    {
        ...
        $job      = new OrderApprovedEmailNotification(new Order(), $staff, true);
    ...
    public function it_is_sent_via_email_channel_if_requirements_are_met(
        ...
        $notification = new OrderApprovedEmailNotification($order, $staff, $shouldSendSupplierEmail);
    ...
    public function it_has_correct_email_recipients()
    {
        ...
        $notification = new OrderApprovedEmailNotification($order, $staff, true);
    ...
    /** @test */
    public function it_sends_an_order_approved_email()
    {
        ...
        $this->assertInstanceOf(OrderApprovedEmail::class, $notification->toMail($staff));
    }
}
