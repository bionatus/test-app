...
use App\Notifications\Supplier\OrderApprovedNotification;
use Config;
...
class OrderApprovedNotificationTest extends TestCase
{
    ...
    {
        $job = new OrderApprovedNotification(new Order());
    ...
    public function it_is_sent_via_twilio_channel_if_requirements_are_met()
    {
        ...
        $notification = new OrderApprovedNotification($order);
    ...
    public function it_sets_twilio_message()
    {
        ...
        $this->assertInstanceOf(TwilioSmsMessage::class, $notification->toTwilio($supplier));
    }
    ...
    public function it_sets_twilio_message_correctly_with_order_name()
    {
        ...
        $order    = Order::factory()->usingSupplier($supplier)->createQuietly(['name' => 'test order 123']);
        ...
        $expected = (new TwilioSmsMessage())->content("BluonLive - Order {$order->name} has been approved ✅ Link: {$linkUrl}. Do Not Reply to this text.");

        $this->assertEquals($expected, $notification->toTwilio($supplier));
    }
    ...
    public function it_sets_twilio_message_correctly_without_order_name()
    {
        ...
        $expected = (new TwilioSmsMessage())->content("BluonLive - Order Bid #{$order->bid_number} has been approved ✅ Link: {$linkUrl}. Do Not Reply to this text.");
