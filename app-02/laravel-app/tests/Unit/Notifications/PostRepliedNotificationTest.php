...
class PostRepliedNotificationTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $this->assertUseTrait(PostRepliedNotification::class, SendsPushNotification::class, ['via']);
    }

    /** @test */
    public function it_can_be_queued()
    {
        $reflection = new ReflectionClass(PostRepliedNotification::class);
    ...
    public function it_uses_database_connection()
    {
        ...
        $notification = new PostRepliedNotification($post);
    ...
    public function it_creates_an_internal_notification_if_requirements_are_met($enabled)
    {
        ...
        new PostRepliedNotification($post);

        $internalNotification = [
            'message'      => 'A new comment has been created for your post.',
            'source_event' => 'replied',
            'source_type'  => 'post',
    ...
    public function it_has_a_correct_fcm_message_and_payload()
    {
        ...
        $body            = 'Your post has a new comment.';
        $title           = 'Post replied';
