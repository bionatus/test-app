...
class CurriDeliveryConfirmationRequiredSmsNotificationTest extends TestCase
{
    /** @test */
    public function it_can_be_queued()
    {
        $reflection = new ReflectionClass(CurriDeliveryConfirmationRequiredSmsNotification::class);
    ...
    {
        $notification = new CurriDeliveryConfirmationRequiredSmsNotification(new Order());
    ...
    public function it_can_notify_via_sms(bool $expected)
    {
        ...
        $notification = new CurriDeliveryConfirmationRequiredSmsNotification($order);
    ...
    public function it_sets_twilio_message()
    {
        ...
        $toTwilio = (new CurriDeliveryConfirmationRequiredSmsNotification($order))->toTwilio(null);
        
        $smsText  = "Bluon - PO $name is ready to be picked up and delivered. Please confirm your delivery details. Do Not Reply to this text.";
