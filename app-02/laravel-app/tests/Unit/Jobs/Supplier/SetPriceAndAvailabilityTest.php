...
class SetPriceAndAvailabilityTest extends TestCase
{
    ...
    {
        $reflection = new ReflectionClass(SetPriceAndAvailability::class);
    ...
    {
        $job = new SetPriceAndAvailability(new Supplier());

        $this->assertSame('database', $job->connection);
    }

    /** @test */
    public function it_updates_supplier_price_and_availability_on_firebase_database()
    {
        ...
        $key = $nodeName . $supplier->getRouteKey() . DIRECTORY_SEPARATOR . 'price_and_availability';
        ...
        $listener = new SetPriceAndAvailability($supplier);
        $listener->handle();
    }
}
