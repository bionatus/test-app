...
class CurriDeliveryRequestTest extends RequestTestCase
{
    use RefreshDatabase;

    protected string $requestClass = CurriDeliveryRequest::class;
    ...
    public function setUp(): void
    {
        ...
        SupplierHour::factory()->createQuietly([
            ...
            'to'          => $date->clone()->setHour(23)->setMinute(00)->format('h:i a'),
        ]);
    ...
    public function timeProvider(): array
    {
        return [
            ...
            [true, Carbon::createFromTime(13)->format('H:i'), Carbon::createFromTime(14)->format('H:i')],
            [false, Carbon::createFromTime(23)->format('H:i'), Carbon::createFromTime(24)->format('H:i')],
        ];
    }
    ...
    public function its_requested_end_time_parameter_should_be_a_valid_value(
        ...
        $request    = $this->formRequest($this->requestClass, [
            RequestKeys::REQUESTED_DATE       => $date = '2023-02-10',
            RequestKeys::REQUESTED_START_TIME => $startTime,
            RequestKeys::REQUESTED_END_TIME   => $endTime,
        ], ['method' => 'post', 'route' => $this->route]);
