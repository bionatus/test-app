...
namespace Tests\Unit\Http\Requests\Api\V3;

use App\Constants\RequestKeys;
use App\Constants\RouteParameters;
use App\Http\Requests\Api\V3\BasePhoneVerifyInvokeRequest;
...
class BasePhoneVerifyInvokeRequestTest extends RequestTestCase
{
    protected string $requestClass = BasePhoneVerifyInvokeRequest::class;
    use RefreshDatabase;
    ...
    public function it_returns_a_phone()
    {
        ...
        $request = BasePhoneVerifyInvokeRequest::create('', 'POST', []);
