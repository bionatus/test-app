...
class StoreRequestTest extends RequestTestCase
{
    ...
    /** @test */
    public function it_requires_tags_if_the_type_is_not_send()
    {
        $request = $this->formRequest($this->requestClass);
    ...
    /** @test
     * @dataProvider dataProviderRequiredTags
     */
    public function it_requires_tags_if_type_is_other_or_null($type)
    {
    ...
    public function dataProviderRequiredTags(): array
    {
        return [
            [null],
            [Post::TYPE_OTHER],
     ...
     */
    public function it_not_requires_tags_if_type_is_funny_or_needs_help(string $type)
    {
        $request = $this->formRequest($this->requestClass,
            [RequestKeys::MESSAGE => 'A message', RequestKeys::TYPE => $type]);
    ...
    {
        $request = $this->formRequest($this->requestClass, [RequestKeys::VIDEO_URL => 'incorrect Url']);
        $request->assertValidationFailed();
    ...
    {
        $request = $this->formRequest($this->requestClass, [RequestKeys::VIDEO_URL => Str::random(256)]);
