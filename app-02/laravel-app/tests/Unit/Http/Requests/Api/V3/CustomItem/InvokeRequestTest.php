...
namespace Tests\Unit\Http\Requests\Api\V3\CustomItem;
...
class InvokeRequestTest extends RequestTestCase
{
    ...
    /** @test */
    public function its_name_must_have_at_least_2_characters()
    {
        ...
        $request->assertValidationErrors([RequestKeys::NAME]);
        $request->assertValidationMessages([
            Lang::get('validation.min.string', ['attribute' => RequestKeys::NAME, 'min' => 2]),
        ]);
    }
