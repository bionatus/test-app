...
class IndexRequestTest extends RequestTestCase
{
    ...
    public function it_requires_a_model_number()
    {
        ...
        $request->assertValidationMessages([Lang::get('validation.required', ['attribute' => RequestKeys::MODEL])]);
    }
    ...
    public function its_model_param_must_be_a_string()
    {
        ...
        $request->assertValidationFailed();
        $request->assertValidationErrors([RequestKeys::MODEL]);
        $request->assertValidationMessages([Lang::get('validation.string', ['attribute' => RequestKeys::MODEL])]);
    }
    ...
    public function it_should_limit_number_param_from_3_chars()
    {
        ...
        $request->assertValidationMessages([
            Lang::get('validation.min.string', ['attribute' => RequestKeys::MODEL, 'min' => 3]),
        ]);
    }
    ...
    public function it_should_limit_number_param_to_200_chars()
    {
        ...
        $request->assertValidationErrors([RequestKeys::MODEL]);
        $request->assertValidationMessages([
            Lang::get('validation.max.string', ['attribute' => RequestKeys::MODEL, 'max' => 200]),
        ]);
    }
