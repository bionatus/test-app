...
namespace Tests\Unit\Http\Resources\Api\V3\Brand\Series\Oem;
...
class BaseResourceTest extends TestCase
{
    ...
    public function it_has_correct_fields()
    {
        ...
        $oem->shouldReceive('getAttribute')->withArgs(['model'])->once()->andReturn($model = 'a model');
        $oem->shouldReceive('getAttribute')->withArgs(['model_notes'])->once()->andReturn($modelNote = 'a model note');
        $oem->shouldReceive('getAttribute')->withArgs(['logo'])->once()->andReturn($logo = 'https://fake-logo');
        $oem->shouldReceive('getAttribute')->withArgs(['unit_image'])->once()->andReturn($image = 'https://fake-image');
