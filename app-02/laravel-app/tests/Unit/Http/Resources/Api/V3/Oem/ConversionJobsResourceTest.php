...
class ConversionJobsResourceTest extends TestCase
{
    ...
    public function it_has_correct_fields()
    {
        ...
        $standardPage = ConversionJob::query()->scoped(new ByControls($standardControls->toArray()))->paginate();
        $optionalPage = ConversionJob::query()->scoped(new ByControls($optionalControls->toArray()))->paginate();
