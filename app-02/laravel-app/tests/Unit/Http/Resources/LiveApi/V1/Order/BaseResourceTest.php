...
use App\Http\Resources\LiveApi\V1\Order\UserResource;
...
class BaseResourceTest extends TestCase
{
    ...
    public function it_has_correct_fields_with_null_values()
    {
        ...
        $orderLockedData->shouldReceive('getAttribute')->withArgs(['user_first_name'])->once()->andReturn('first name');
        $orderLockedData->shouldReceive('getAttribute')->withArgs(['user_last_name'])->once()->andReturn('last name');
        $orderLockedData->shouldReceive('getAttribute')->withArgs(['user_company'])->once()->andReturn('company name');
        $orderLockedData->shouldReceive('getAttribute')
            ->withArgs(['user_public_name'])
            ->once()
            ->andReturn('public name');
        ...
        $order->shouldReceive('getAttribute')->withArgs(['orderLockedData'])->once()->andReturn($orderLockedData);
