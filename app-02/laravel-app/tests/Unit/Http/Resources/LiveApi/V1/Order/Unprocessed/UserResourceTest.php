...
class UserResourceTest extends TestCase
{
    ...
    public function it_has_correct_fields_with_all_data()
    {
        ...
        $oldestPendingOrder->shouldReceive('getAttribute')
            ->withArgs(['created_at'])
            ->once()
            ->andReturn($oldestPendingOrderCreatedAt = Carbon::now());
        ...
        $data = [
            ...
            'oldest_pending_order_created_at' => $oldestPendingOrderCreatedAt,
        ];
