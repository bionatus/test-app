...
class DetailedResourceTest extends TestCase
{
    ...
    public function it_has_correct_fields_with_null_values()
    {
        ...
        $builder->shouldReceive('exists')->withNoArgs()->once()->andReturnTrue();

        $belongsToMany = Mockery::mock(BelongsToMany::class);
        $belongsToMany->shouldReceive('scoped')->withAnyArgs()->once()->andReturn($builder);
        ...
        $order->shouldReceive('getAttribute')->with('note')->once()->andReturnNull();
        ...
        $order->shouldReceive('items')->withNoArgs()->once()->andReturn($belongsToMany);
        $order->shouldReceive('itemOrders')->withNoArgs()->once()->andReturn($hasMany);
    ...
    public function it_has_correct_fields()
    {
        ...
        $supplierUsers->shouldReceive('scoped')->withAnyArgs()->once()->andReturnSelf();
        ...
        $user->shouldReceive('supplierUsers')->withNoArgs()->once()->andReturn($supplierUsers);
