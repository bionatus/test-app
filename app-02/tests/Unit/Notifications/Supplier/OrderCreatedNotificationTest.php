...
use App\Notifications\Supplier\OrderCreatedNotification;
use Config;
...
class OrderCreatedNotificationTest extends TestCase
{
    ...
    {
        $job = new OrderCreatedNotification(new Order());
    ...
    public function it_sets_twilio_message()
    {
        ...
        $smsText = "BluonLive - {$order->user->fullName()} from {$order->user->companyName()} has sent a new Order Request to {$order->supplier->address}!. Do Not Reply to this text.";
