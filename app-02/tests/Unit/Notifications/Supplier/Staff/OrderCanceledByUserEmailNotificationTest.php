...
use App\Notifications\Supplier\Staff\OrderCanceledByUserEmailNotification;
...
class OrderCanceledByUserEmailNotificationTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $reflection = new ReflectionClass(OrderCanceledByUserEmailNotification::class);
    ...
    public function it_uses_database_connection()
    {
        ...
        $job      = new OrderCanceledByUserEmailNotification(new Order(), $staff, true);
    ...
    public function it_is_sent_via_email_channel_if_requirements_are_met(
        ...
        $notification = new OrderCanceledByUserEmailNotification($order, $staff, $shouldSendSupplierEmail);
    ...
    public function it_has_correct_email_recipients()
    {
        ...
        $notification = new OrderCanceledByUserEmailNotification($order, $staff, true);
    ...
    /** @test */
    public function it_sends_an_order_canceled_email()
    {
        ...
        $this->assertInstanceOf(OrderCanceledEmail::class, $notification->toMail($staff));
    }
}
