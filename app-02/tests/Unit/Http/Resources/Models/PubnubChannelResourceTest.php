...
use App\Http\Resources\Models\PubnubChannelResource;
...
class PubnubChannelResourceTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_has_correct_fields()
    {
        ...
        $resource = new PubnubChannelResource($pubnubChannel);
        ...
        $schema = $this->jsonSchema(PubnubChannelResource::jsonSchema(), false, false);
