...
class OemResourceTest extends TestCase
{
    ...
    public function it_has_correct_fields()
    {
        ...
        $oem->shouldReceive('getAttribute')->with('refrigerant')->once()->andReturn($refrigerant = 'refrigerant');
    ...
    public function it_has_correct_fields_with_null_values()
    {
        ...
        $oem->shouldReceive('getAttribute')->with('logo')->once()->andReturn($logo = 'https://fake-logo');
        $oem->shouldReceive('getAttribute')->with('refrigerant')->once()->andReturnNull();
