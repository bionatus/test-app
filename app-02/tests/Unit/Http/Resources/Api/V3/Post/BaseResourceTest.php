...
namespace Tests\Unit\Http\Resources\Api\V3\Post;
...
use App\Http\Resources\Api\V3\Post\CommentResource;
...
class BaseResourceTest extends TestCase
{
    ...
    public function it_has_correct_fields_with_data()
    {
        ...
        $user->shouldReceive('getAttribute')->with('city')->once()->andReturn('City user');
        $user->shouldReceive('getAttribute')->withArgs(['state'])->andReturn(CountryDataType::UNITED_STATES . '-AR');
        $user->shouldReceive('getAttribute')->withArgs(['country'])->once()->andReturn(CountryDataType::UNITED_STATES);
        $user->shouldReceive('getAttribute')->with('company')->once()->andReturn('Company user');
        $user->shouldReceive('getAttribute')->with('experience_years')->once()->andReturn(10);
