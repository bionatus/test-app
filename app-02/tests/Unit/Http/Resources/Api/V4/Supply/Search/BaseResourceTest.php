...
namespace Tests\Unit\Http\Resources\Api\V4\Supply\Search;
...
class BaseResourceTest extends TestCase
{
    ...
    public function it_has_correct_fields_with_null_values()
    {
        ...
        $item->shouldReceive('getRouteKey')->withNoArgs()->once()->andReturn($id = 'fake-item-id');
        ...
        $supply->shouldReceive('getAttribute')->with('item')->andReturn($item);
        $supply->shouldReceive('getAttribute')->with('name')->once()->andReturn($name = 'fake-supply-name');
    ...
    public function it_has_correct_fields_with_data()
    {
        ...
        $item->shouldReceive('getFirstMedia')->with('images')->andReturn($media);
