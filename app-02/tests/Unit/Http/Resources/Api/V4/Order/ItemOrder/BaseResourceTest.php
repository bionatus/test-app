...
namespace Tests\Unit\Http\Resources\Api\V4\Order\ItemOrder;
...
class BaseResourceTest extends TestCase
{
    ...
    public function it_has_correct_fields_with_part_and_without_replacement()
    {
        ...
        $itemOrder = ItemOrder::factory()->usingOrder($order)->usingItem($part->item)->createQuietly();
    ...
    /** @test */
    public function it_has_correct_fields_with_part_hiding_part_number()
    {
        $order     = Order::factory()->pending()->create();
        $part      = Part::factory()->create();
        $itemOrder = ItemOrder::factory()->usingItem($part->item)->usingOrder($order)->createQuietly();
        ...
        $data = [
            ...
            'custom_detail'            => $itemOrder->custom_detail,
            'generic_part_description' => $itemOrder->generic_part_description,
            'item'                     => new ItemResource($itemOrder->item, true),
            'replacement'              => null,
            'initial_request'          => true,
        ];
