...
namespace Tests\Feature\LiveApi\V1\Oem\Part;

use App\Constants\RouteNames;
use App\Http\Controllers\LiveApi\V1\Oem\PartController;
...
class IndexTest extends TestCase
{
    ...
    private string $routeName = RouteNames::LIVE_API_V1_OEM_PART_INDEX;
