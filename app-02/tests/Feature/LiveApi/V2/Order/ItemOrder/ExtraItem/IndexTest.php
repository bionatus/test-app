...
class IndexTest extends TestCase
{
    ...
    private string $routeName = LiveApiV2::LIVE_API_V2_ORDER_ITEM_ORDER_EXTRA_ITEM_INDEX;
    ...
    /** @test */
    public function it_display_a_list_of_item_order_added_on_the_initial_request()
    {
        $staff      = Staff::factory()->createQuietly();
        $supplier   = $staff->supplier;
        $order      = Order::factory()->usingSupplier($supplier)->create();
        ...
        ItemOrder::factory()->usingOrder($order)->notInitialRequest()->create();
